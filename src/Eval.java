// $ANTLR 3.5.2 Eval.g 2017-01-17 11:09:16
...
public class Eval extends TreeParser {
	...
	// $ANTLR start "expr"
	// Eval.g:25:1: expr returns [int value] : ( ^( '+' a= expr b= expr ) | ^( '-' a= expr b= expr ) | ^( '*' a= expr b= expr ) | ID | INT );
